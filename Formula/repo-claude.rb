...
# DEPRECATED: This formula is deprecated. Please use 'muno' instead.
class RepoClaude < Formula
  desc "[DEPRECATED] Use 'muno' instead - Multi-repository UNified Orchestration"
  ...
  def post_install
    opoo "This formula is deprecated. Please use 'brew install muno' instead."
    opoo "The binary will be installed as 'rc' but MUNO provides 'muno' command."
  end
